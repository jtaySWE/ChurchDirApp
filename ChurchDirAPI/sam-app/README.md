...
```bash
sam-app$ sam local invoke helloFromLambdaFunction --no-event
```
...
```bash
sam-app$ sam logs -n helloFromLambdaFunction --stack-name sam-app --tail
```
...
```bash
sam-app$ dotnet test test/sam-app.Tests/sam-app.Tests.csproj 
```
